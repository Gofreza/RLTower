...
: Equipment(ring.getId(), ring.getName(), ring.getDescription(), ring.getType(), ring.getWeight(), ring.getRarity(), ring.getDurability(), ring.getPhyDefense(), ring.getMagDefense(), ring.getImagePath(), ring.getEffects(), ring.getRequirements()){
}
